...
import DefaultBanner from "../../assets/community-default-banner.svg";
...
const JoinedCommunityCard = ({ community }) => {
  ...
  <Link to={`/community/${community.name}`} className="flex flex-col mb-5 bg-white w-full px-4 py-4 border shadow-2xl shadow-[#f2f5fc] rounded-md">
      <img className="" src={community.banner || DefaultBanner} alt="" loading="lazy" onError={(e) => { e.target.onerror = null; e.target.src = DefaultBanner; }} />
